  ...
  return {
    newWorkspace(name?: string) {
      ...
      store.setState({
        ...
        currentImage: null,
        canvasNodes: newWorkspace.canvasNodes ?? [],
        canvasViewport: newWorkspace.canvasViewport ?? null,
        selectedNodeId: newWorkspace.selectedNodeId ?? null,
        batchResults: [],
        resultGridOpen: false,
        annotations: [],
        strokes: [],
    ...
    switchWorkspace(id: string) {
      ...
      store.setState({
        ...
        canvasNodes: target.canvasNodes ?? [],
        canvasViewport: target.canvasViewport ?? null,
    ...
    closeWorkspace(id: string) {
      ...
      if (state.activeWorkspaceId === id) {
        ...
        store.setState({
          ...
          canvasNodes: next.canvasNodes ?? [],
          canvasViewport: next.canvasViewport ?? null,
