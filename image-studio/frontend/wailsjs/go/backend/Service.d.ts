...
export function CheckForAppUpdate():Promise<backend.AppUpdateInfo>;
...
export function CompatibilityStatePath():Promise<string>;

export function CreateVideo(arg1:backend.VideoOptions):Promise<backend.VideoResult>;
...
export function ExportUpstreamConfigToFile(arg1:string):Promise<string>;
...
export function ImportPromptByToken(arg1:string):Promise<backend.PromptImportPayload>;
...
export function LoadCodexAPIConfig():Promise<backend.CodexAPIConfig>;

export function LoadCompatibilityState():Promise<compat.State>;
...
export function PollVideo(arg1:backend.VideoPollOptions):Promise<backend.VideoResult>;
...
export function SaveCompatibilityState(arg1:compat.State):Promise<void>;
...
export function WriteAppUpdateProbe(arg1:backend.AppUpdateProbeResult):Promise<void>;
